package com.jaats.agrovehicle.net;


public class ServiceNames {
    //http://dwarkamart.in/api/user/register
    /*Set BASE URL here*/
    private static final String API = "http://nkploggy.com/";
   ...
   /**/ public static final String REGISTRATION = API + "api/user/mobilesignup";
   /**/ public static final String USER_LOGIN = API + "api/user/login";
